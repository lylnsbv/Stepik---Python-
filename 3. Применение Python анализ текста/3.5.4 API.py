...
api_token = requests.post(token_url, params=params_token).json()['token']
headers = {'X-Xapp-Token': api_token}

a = []
with open('input.txt', 'r') as inf:
    for line in inf.readlines():
        r = requests.get(f'https://api.artsy.net/api/artists/{line.strip()}', headers=headers).json()
        a.append((r['birthday'], r['sortable_name']))
print(*[n[1] for n in sorted(a)], sep='\n')
